...
# Update this path to match your local setup, e.g.:
DATA_FOLDER = "C:/Users/johnb/Documents/GitHub/NSVB/supplemental_tables"
```

```{r}
# Species reference table
ref_spp <- read_csv(paste0(DATA_FOLDER, "/REF_SPECIES.csv")) |> 
...
vol_ib <- read_csv(paste0(DATA_FOLDER, "/Table S1a_volib_coefs_spcd.csv")) |> 
  rename(MODEL = model)
vol_ib_jenkins <- read_csv(paste0(DATA_FOLDER, "/Table S1b_volib_coefs_jenkins.csv")) |> 
  rename(MODEL = model)
...
vol_bark <- read_csv(paste0(DATA_FOLDER, "/Table S2a_volbk_coefs_spcd.csv")) |> 
  rename(MODEL = model)
vol_bark_jenkins <- read_csv(paste0(DATA_FOLDER, "/Table S2b_volbk_coefs_jenkins.csv")) |> 
  rename(MODEL = model)
...
vol_ob1 <- read_csv(paste0(DATA_FOLDER, "/Table S3a_volob_coefs_spcd.csv")) |> 
  rename(MODEL_ob = model)
vol_ob2 <- read_csv(paste0(DATA_FOLDER, "/Table S4a_rcumob_coefs_spcd.csv")) |> 
  rename(MODEL_rcumob = model)
vol_ob <- inner_join(vol_ob1, vol_ob2, by = c("SPCD", "DIVISION", "STDORGCD"))

vol_ob1_jenkins <- read_csv(paste0(DATA_FOLDER, "/Table S3b_volob_coefs_jenkins.csv")) |> 
  rename(MODEL_ob = model)
vol_ob2_jenkins <- read_csv(paste0(DATA_FOLDER, "/Table S4b_rcumob_coefs_jenkins.csv")) |> 
  rename(MODEL_rcumob = model)
...
vol_ratio <- read_csv(paste0(DATA_FOLDER, "/Table S5a_rcumib_coefs_spcd.csv")) |> 
  rename(MODEL = model)
vol_ratio_jenkins <- read_csv(paste0(DATA_FOLDER, "/Table S5b_rcumib_coefs_jenkins.csv")) |> 
  rename(MODEL = model)
...
```{r}
wdsg <- read_csv(paste0(DATA_FOLDER, "/REF_SPECIES.csv")) |> 
...
bark_wt <- read_csv(paste0(DATA_FOLDER, "/Table S6a_bark_biomass_coefs_spcd.csv")) |> 
  rename(MODEL = model)
bark_wt_jenkins <- read_csv(paste0(DATA_FOLDER, "/Table S6b_bark_biomass_coefs_jenkins.csv")) |> 
  rename(MODEL = model) |> 
  mutate(b1 = NA)
...
branch_wt <- read_csv(paste0(DATA_FOLDER, "/Table S7a_branch_biomass_coefs_spcd.csv")) |> 
  rename(MODEL = model)
branch_wt_jenkins <- read_csv(paste0(DATA_FOLDER, "/Table S7b_branch_biomass_coefs_jenkins.csv")) |> 
  rename(MODEL = model) |> 
  mutate(b1 = NA)
...
cr_prop <- read_csv(paste0(DATA_FOLDER, "/Table S11_mean_crprop.csv")) |> 
...
eco_div_prov <- read_csv(paste0(DATA_FOLDER, "/eco_div_prov.csv")) |> 
...
agb <- read_csv(paste0(DATA_FOLDER, "/Table S8a_total_biomass_coefs_spcd.csv")) |> 
  rename(MODEL = model)
agb_jenkins <- read_csv(paste0(DATA_FOLDER, "/Table S8b_total_biomass_coefs_jenkins.csv")) |> 
  rename(MODEL = model)
...
foliage <- read_csv(paste0(DATA_FOLDER, "/Table S9a_foliage_coefs_spcd.csv")) |> 
  rename(MODEL = model)
foliage_jenkins <- read_csv(paste0(DATA_FOLDER, "/Table S9b_foliage_coefs_jenkins.csv")) |> 
...
```{r}
# Carbon fractions
spp_live <- read_csv(paste0(DATA_FOLDER, "/Table S10a_fia_wood_c_frac_live.csv")) |> 
  select(SPCD, fia.wood.c) |> 
  rename(CF = fia.wood.c) |> 
  filter(SPCD <= 999)

spp_dead <- read_csv(paste0(DATA_FOLDER, "/Table S10b_fia_wood_c_frac_dead.csv")) |> 
